...
namespace BasicCleanArch
{
    ...
    public class Result<T>
    {
        ...
        public Result(T value) { _value = value; _tag = 1; }
        ...
        public Result(Exception error) { _error = error; _tag = 2; }
            ...
            )
        {
            ...
            switch (_tag)
            {
                case 1: successHandler(_value); break;
                case 2: errorHandler(_error); break;
